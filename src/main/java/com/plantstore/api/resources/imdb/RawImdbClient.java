...
public class RawImdbClient {
     ...
     */
    public PlantstoreApiHttpResponse<String> createMovie(CreateMovieRequest request) {
     ...
     * Add a movie to the database
     */
    public PlantstoreApiHttpResponse<String> createMovie(CreateMovieRequest request, RequestOptions requestOptions) {
     ...
     */
    public PlantstoreApiHttpResponse<Movie> getMovie(String id) {
     ...
     * Retrieve a movie from the database based on the ID
     */
    public PlantstoreApiHttpResponse<Movie> getMovie(String id, RequestOptions requestOptions) {
        HttpUrl httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
                .addPathSegments("movies")
                .addPathSegment(id)
